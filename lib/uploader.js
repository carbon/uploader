...
(function (Carbon) {
    ...
    var DropHandler = (function () {
        ...
        DropHandler.prototype.onDragEnter = function (e) {
            ...
            if (dropElement) {
                Array.from(document.querySelectorAll('.dragOver')).forEach(function (el) {
        ...
        DropHandler.prototype.onDragEnd = function (e) {
            trigger(e.target, 'carbon:dragend', {
                originalEvent: e
            });
        };
    ...
    var DropboxChooser = (function () {
        ...
        DropboxChooser.prototype.open = function () {
            if (!this.loaded) {
        ...
        DropboxChooser.prototype.subscribe = function (callback) {
            return this.reactive.subscribe(callback);
        };
